...
paru -S --noconfirm burpsuite candy-icons-git davinci-resolve dropbox google-chrome nerd-fonts-mononoki onedrive-abraunegg \
  picom-jonaburg-git siji-git teams ttf-meslo ttf-ms-fonts ttf-unifont nerd-fonts-iosevka cpuid2cpuflags auto-cpufreq otf-font-awesome-5 \
  polybar ttf-material-design-icons-git appimagelauncher
...
sudo pacman -S --noconfirm xorg bspwm sxhkd firefox nitrogen lxappearance dmenu arandr arc-gtk-theme arc-icon-theme obs-studio vlc \
  ...
  scrot dunst pacman-contrib sublime-text cuda composer file-roller filezilla htop imagemagick img2pdf mousetweaks nodejs npm php \
  ...
  xorg-xinit pcmanfm keychain alacritty autorandr gitui networkmanager-openvpn nvidia-dkms ranger ripgrep the_silver_searcher \
