...
sudo aura -A --noconfirm burpsuite candy-icons-git davinci-resolve dropbox google-chrome nerd-fonts-mononoki onedrive-abraunegg picom-jonaburg-git siji-git teams ttf-meslo ttf-ms-fonts ttf-unifont nerd-fonts-iosevka cpuid2cpuflags auto-cpufreq otf-font-awesome-5-free polybar ttf-material-design-icons-git
