...
paru -S --noconfirm burpsuite candy-icons-git dropbox google-chrome nerd-fonts-mononoki onedrive-abraunegg picom-jonaburg-git siji-git teams ttf-meslo ttf-ms-fonts ttf-unifont nerd-fonts-iosevka otf-font-awesome-5-free polybar ttf-material-design-icons-git appimagelauncher
