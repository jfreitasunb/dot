...
cd ~/GitHub/dot/gondor/dot_config/
...
sudo ln -s ~/GitHub/dot/gondor/logind/sleep.conf /etc/systemd/sleep.conf

sudo ln -s ~/GitHub/dot/gondor/logind/logind.conf /etc/systemd/logind.conf
...
sudo ln -s ~/GitHub/dot/gondor/maquinas_virtuais/qemu /etc/libvirt/

sudo ln -s ~/GitHub/dot/gondor/maquinas_virtuais/storage /etc/libvirt/

sudo ln -s /home/jfreitas/GitHub/dot/gondor/maquinas_virtuais/qemu.conf /etc/libvirt/
