...
alias l.='exa -a | egrep "^\."'
alias l.='exa -al --color=always --group-directories-first ../' # ls on the PARENT directory
alias l..='exa -al --color=always --group-directories-first ../../' # ls on directory 2 levels up
