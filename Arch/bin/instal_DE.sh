...
yay -S --needed firefox nitrogen lxappearance dmenu arandr arc-gtk-theme arc-icon-theme vlc \
  ...
  dconf-editor gparted texstudio tldr linux-lts-headers gdal jq burpsuite candy-icons-git picom siji-git ttf-meslo ttf-ms-fonts ttf-unifont auto-cpufreq \
