...
EXCLUDE_LIST_LARAVEL="/ArquivosLinux/Dropbox/Backups/Gondor/excludes/exclude-GitHub_Repos_laravel.list"
...
DEST_AULASONLINE="/ArquivosLinux/Dropbox/UnB/Disciplinas/Graduacao/pdf_video_aulas"
