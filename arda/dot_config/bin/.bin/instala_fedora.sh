...
sudo ln -s ~/GitHub/dot/arda/grub/grub /etc/default/grub
...
sudo ln -s ~/GitHub/dot/arda/logind/sleep.conf /etc/systemd/sleep.conf

sudo ln -s ~/GitHub/dot/arda/logind/logind.conf /etc/systemd/logind.conf
...
sudo ln -s ~/GitHub/dot/arda/maquinas_virtuais/qemu /etc/libvirt/

sudo ln -s ~/GitHub/dot/arda/maquinas_virtuais/storage /etc/libvirt/

sudo ln -s /home/jfreitas/GitHub/dot/arda/maquinas_virtuais/qemu.conf /etc/libvirt/
